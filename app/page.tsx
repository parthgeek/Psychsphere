          ...
          >
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-xl sm:text-2xl text-slate-700 font-medium mb-4">
                Online Therapy for Anxiety, Relationships, Emotional Well-being.
              </p>
              <p className="text-lg text-gray-500 mb-8">
                Evidence-based counseling sessions with trained psychologists.
              </p>
              <motion.a
                href="#booking"
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.98 }}
                className="inline-block bg-teal-700 text-white px-8 py-3 rounded-lg hover:bg-teal-800 transition-colors font-semibold"
              >
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl sm:text-4xl font-light text-slate-900 tracking-tight mb-8">
                Why Choose <span className="font-semibold text-[#5A8B94]">PsychSphere</span>
              </h2>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={item} className="flex items-center gap-3">
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#5A8B94]/15 flex items-center justify-center">
                      <svg className="w-3.5 h-3.5 text-[#5A8B94]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
